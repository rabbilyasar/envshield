...
2026-08-26: `BL-001` and `BL-002` fixed (code, not yet released — see their
own entries); `BL-003`, `BL-004` remain open.** Release readiness still
