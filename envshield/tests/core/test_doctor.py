...
def test_doctor_all_ok(mocker):
    ...
    mocker.patch("envshield.core.doctor._check_local_env_sync", return_value=(True, "OK"))
    mocker.patch("envshield.core.doctor._check_example_file_sync", return_value=(True, "OK"))
...
def test_doctor_with_issues(mocker):
    ...
    mocker.patch("envshield.core.doctor._check_config_files", return_value=(False, "Config missing"))
    mocker.patch("envshield.core.doctor._check_local_env_sync", return_value=(True, "OK"))
    mocker.patch("envshield.core.doctor._check_example_file_sync", return_value=(False, "Example out of sync"))
    mocker.patch("envshield.core.doctor._check_git_hook", return_value=(True, "OK"))
...
def test_doctor_fix_flow(mocker):
    ...
    mocker.patch("envshield.core.doctor._check_git_hook", return_value=(False, "Hook not installed"))
    ...
    mocker.patch("envshield.core.doctor._check_git_hook", side_effect=[(False, "Not installed"), (True, "OK")])
